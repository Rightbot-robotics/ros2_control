...
int main() {
     ...
     auto rotating_sink = std::make_shared<spdlog::sinks::rotating_file_sink_mt>("/home/inderjeet/projects/sherlock_ws/robot_logs/hardware_interface_logs/hardware_interface_data_logs.txt", 1024*1024*100, 3);
    ...
    logger_->info("created unique instance of interface 2");
    ...
    logger_->info("created unique instance of interface 3");
