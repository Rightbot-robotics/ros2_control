...
def generate_launch_description():
    ...
    urdf_path = get_package_share_directory('amc_motor_actuator_test') + '/urdf/gpio_test.urdf'
    ...
    gpio_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["gpio_controller", "-c", "/controller_manager", "--controller-manager-timeout=360"],
    )
